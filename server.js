...
client.on('ready', () => {
    wait(1000);
    client.user.setPresence({ activity: { name: 'Some things can`t be solved' }, status: 'idle' })
...
client.config = {
    token: 'ODAyNTU4MzAxNzU2NzE5MTU1.YAw-qQ.MlXaPn7XUepwhVOUWkCgJ82zTCQ', //token
    banMembers: ['827889473172799509'], // Ban yetkilileri
    jailMembers: ['827889626479853638'], // Jail yetkilileri
    jailRoles: ['806258056098349108'], // Jail rolleri
    muteMembers: ['827889617562501123'], // Yetkili rolleri
    muteRoles: ['806258055712866304'], // chat mute rolleri
    voicemuteRoles: ['827889622288826419'], // ses mute rolleri
    üstYönetim: ['827889630653055019', '823934747088125983'], //Üst Yönetim rolleri
    mesajLog: '', //Mesaj log
    vipRoles: ['823939230459625524'], //vip rolleri
    boosterRoles: '827889639431208962', //boosterrolü
    ekipRoles: ['807571844642504715'], //taglı rolü
    unregisteres: ['823909583935766599'], //kayıtsız rolü
    manRoles: ['823940489887219724'],
    girlRoles: ['823939563197431848'], //kız rolleri
    mods: ['823938597144887308'], //mod rolleri
    chat: '799342104396300311', //chat idsi
    channelID: '830044697590366211', //kayıt kanalı id
    tag: 'SYMBOL_1', //tag
    guildID: '830044697590366208', //sunucu id
...
"746418571801788538": true,
"818919592139292722": true,
"": true
};
...
client.on('message', (message) => {
  if(message.attachments.size >= 1){
   if(message.channel.id == "799342104396300311"){//chat kanalı
...
client.on("userUpdate", async function(oldUser, newUser) {
  ...
  const embed = new Discord.MessageEmbed().setAuthor(member.displayName, member.user.avatarURL({ dynamic: true })).setColor('#ff0000').setTimestamp().setFooter('Solve?');
